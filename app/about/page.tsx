...
const milestones = [
  {
    year: "2020",
    title: "公司成立",
    desc: "北京张量无限科技有限公司在北京中关村智造大街成立，核心团队来自清华、北航等顶尖院校机器人实验室。",
  },
  {
    year: "2021",
    title: "首款3D相机发布",
    desc: "推出首款户外高精度3D相机，实现亚毫米级精度成像，填补国内户外3D感知空白。",
  },
  {
    year: "2022",
    title: "光伏行业规模化落地",
    desc: "3D感知方案在多个GW级光伏电站实现规模化部署，成为行业头部解决方案。",
  },
  {
    year: "2023",
    title: "户外作业机器人发布",
    desc: "推出户外作业机器人，融合自主导航与3D感知，成功应用于农业、林业、石油等领域。",
  },
  {
    year: "2024",
    title: "出海与平台化",
    desc: "产品进入海外市场，建立模块化技术平台，支持更多行业应用的快速开发与部署。",
  },
];
